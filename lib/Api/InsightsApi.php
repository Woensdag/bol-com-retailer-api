...
class InsightsApi
{
     ...
     * @return \Swagger\Client\Model\OfferInsights
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OfferInsights, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOfferInsightsWithHttpInfo($offer_id, $period, $number_of_periods, $name)
    {
        $returnType = '\Swagger\Client\Model\OfferInsights';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OfferInsights',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PerformanceIndicators
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PerformanceIndicators, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPerformanceIndicatorWithHttpInfo($name, $year, $week)
    {
        $returnType = '\Swagger\Client\Model\PerformanceIndicators';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PerformanceIndicators',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\SalesForecastResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\SalesForecastResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSalesForecastWithHttpInfo($offer_id, $weeks_ahead)
    {
        $returnType = '\Swagger\Client\Model\SalesForecastResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\SalesForecastResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
