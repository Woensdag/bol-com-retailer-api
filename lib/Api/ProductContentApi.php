...
class ProductContentApi
{
     ...
     * @return \Swagger\Client\Model\ValidationReportResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ValidationReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getValidationReportWithHttpInfo($upload_id)
    {
        $returnType = '\Swagger\Client\Model\ValidationReportResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ValidationReportResponse',
     ...
     *
     * @param  \Swagger\Client\Model\CreateProductContentRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Post product content
     *
     * @param  \Swagger\Client\Model\CreateProductContentRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
