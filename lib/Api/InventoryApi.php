...
class InventoryApi
{
     ...
     * @return \Swagger\Client\Model\InventoryResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InventoryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryWithHttpInfo($page = '1', $quantity = null, $stock = null, $state = null, $query = null)
    {
        $returnType = '\Swagger\Client\Model\InventoryResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\InventoryResponse',
