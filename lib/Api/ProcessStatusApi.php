...
class ProcessStatusApi
{
     ...
     *
     * @param  \Swagger\Client\Model\BulkProcessStatusRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ProcessStatusResponse
     */
     ...
     * Gets the status of multiple asynchronous processes by an array of process status ids for a retailer
     *
     * @param  \Swagger\Client\Model\BulkProcessStatusRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ProcessStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProcessStatusBulkWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\ProcessStatusResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ProcessStatusResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
