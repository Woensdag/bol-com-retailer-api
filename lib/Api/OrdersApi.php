...
class OrdersApi
{
     ...
     *
     * @param  \Swagger\Client\Model\ContainerForTheOrderItemsThatHaveToBeCancelled_ $body body (optional)
     *
     ...
     * Cancel an order item by an order item id
     *
     * @param  \Swagger\Client\Model\ContainerForTheOrderItemsThatHaveToBeCancelled_ $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ReducedOrders
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ReducedOrders, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($page = '1', $fulfilment_method = 'FBR', $status = 'OPEN')
    {
        $returnType = '\Swagger\Client\Model\ReducedOrders';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ReducedOrders',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrdersRequest($page = '1', $fulfilment_method = 'FBR', $status = 'OPEN')
    {
        if ($page !== null && $page < 1) {
     ...
     * Ship order item
     *
     * @param  \Swagger\Client\Model\ShipmentRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ProcessStatus
     ...
     * Ship order item
     *
     * @param  \Swagger\Client\Model\ShipmentRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ProcessStatus, HTTP status code, HTTP response headers (array of strings)
