...
class CommissionsApi
{
     ...
     * @return \Swagger\Client\Model\Commission
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Commission, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommissionWithHttpInfo($ean, $unit_price, $condition = 'NEW')
    {
        $returnType = '\Swagger\Client\Model\Commission';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\Commission',
     ...
     *
     * @param  \Swagger\Client\Model\BulkCommissionRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\BulkCommissionResponse
     */
     ...
     * Get all commissions and reductions by EAN in bulk
     *
     * @param  \Swagger\Client\Model\BulkCommissionRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BulkCommissionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommissionsWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\BulkCommissionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\BulkCommissionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
